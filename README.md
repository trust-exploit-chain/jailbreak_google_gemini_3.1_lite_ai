...
Step 3: Type this text

Step 4: Type what you want the model to do

Step 5: Done—here’s the final version

Step 6: If it doesn't work, it means Google has fixed it. Sorry, there's nothing we can do about it now.
